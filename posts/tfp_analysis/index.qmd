...
#economic income class TFP plot  
...
Full model: $$TFP = \beta_0 + \beta_1*land_i + \beta_2*capital_i + \beta_3*labor_i  + \beta_4*land_i:capital_i + \beta_5*land_i:labor_i + \beta_6*land_i:capital_i + \varepsilon_i$$

Reduced model: $$TFP = \beta_0 + \beta_1*land_i + \beta_2*capital_i + \beta_3*labor_i + \beta_4 * land_i:capital_i + \varepsilon_i$$
...
The final model is given by: $$log(TFP) = \beta_0 + \beta_1*land_i + \beta_2*capital_i + \beta_3*labor_i + \beta_4 * land_i:capital_i + \varepsilon_i$$
...
caption = 'Figure 3. Mean difference testing \n for TFP in varying income classes',
